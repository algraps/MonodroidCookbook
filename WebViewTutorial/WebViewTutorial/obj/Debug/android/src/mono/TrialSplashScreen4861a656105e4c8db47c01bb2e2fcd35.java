...
public class TrialSplashScreen4861a656105e4c8db47c01bb2e2fcd35 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen4861a656105e4c8db47c01bb2e2fcd35.this, webviewtutorial.Activity1.class);
